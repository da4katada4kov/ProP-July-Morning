    ...
    <div class="container">
			...
			<div class="box4e">
                ...
                <div class="goten">
                        ...
                        <input type="text"
                               name="reciever"
                               value="dream.team.fontys@gmail.com"
                               readonly
                               >
                        <h6>Message:</h6>
                        <textarea
        ...
        <div class="fb-comments" data-href="https://www.facebook.com/july.morning.dream.team/" data-numposts="5"></div>
        <iframe src="http://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fjuly.morning.dream.team&width=600&colorscheme=light&show_faces=true&border_color&border_radius&stream=true&header=true&height=435&margin" 
                scrolling="yes" 
                frameborder="0" 
            ...
            <br>
            <a class="twitter-timeline"  href="https://twitter.com/Dream_Team_Fon" 
               data-widget-id="734461852734922752"
               width=400
               height=430>Tweets by July Morning</a>
<br>
             <a href="https://twitter.com/intent/tweet?screen_name=Dream_Team_Fon" class="twitter-mention-button">Tweet to @Dream_Team_Fon</a>     
</div>
